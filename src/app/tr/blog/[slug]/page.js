			...
			<div className="">
				...
				<div className="grid grid-cols-10">
									...
									<div className="flex flex-row gap-2">
										{post.categories.length !== 0 &&
											post.categories.map((element, index) => (
												<div key={index} className="text-lg font-light text-gray-700 flex flex-row items-center gap-1 border bg-color3/75 px-1 rounded-md"><MdDiscount size={14}/> {element.TR_title}</div>
											))
										}
									</div>
								</div>
					...
					<div className="px-8 col-start-1 col-end-11 md:col-start-2 md:col-end-10 lg:col-start-3 lg:col-end-9 w-full">
						<ReactMarkdown className="text-blue-400 flex flex-col gap-4" children={post.TR_content} components={{
