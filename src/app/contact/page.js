	...
	return (
		<div className="w-full h-full bg-contact">
			...
			<div className="px-40 flex flex-col gap-14">
				<motion.div initial={{ opacity: 0, translateX: -60 }} animate={{ opacity: 1, translateX: 0 }} className="shadow-xl border rounded-md border-contact-secondary bg-contact-secondary grid grid-cols-2 grid-rows-1 p-12 gap-7">
				...
				<motion.div initial={{ opacity: 0, translateX: 60 }} animate={{ opacity: 1, translateX: 0 }} className="shadow-xl border rounded-md border-contact-secondary bg-contact-secondary grid grid-cols-2 p-12 gap-7">
					<div className="flex items-center justify-center">
						<Image src={emre} className="w-80 h-80 shadow-2xl shadow-black mr-8 rounded-full" />
					</div>
