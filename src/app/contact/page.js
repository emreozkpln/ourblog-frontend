	...
	return (
		<div className="w-full bg-gray-200 flex flex-col gap-14">
			...
			<div className="px-20 md:px-40 flex flex-col gap-20 text-white">
				<div className="w-[300px] md:w-full shadow-2xl shadow-gray-600 rounded-xl bg-gradient-to-r from-color3 via-color2 to-color1 grid grid-cols-2 grid-rows-1 p-12 gap-7">
				...
				<div className="w-[300px] md:w-full shadow-2xl shadow-gray-600 rounded-xl bg-gradient-to-r from-color1 via-color2 to-color3 grid grid-cols-2 p-12 gap-7 mb-20">
					<div className="flex items-center justify-center">
